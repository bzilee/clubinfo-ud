	...
	<form class="register-members" token="<?php echo $token; ?>">
  	...
  	<!--  -->
	  	...
	  	<div class="col s12 m12 l12 select-field"  which="hh">
			<input type="submit" name="submit" value="Soumettre" class="btn btn-submit-register" id="submit-register" identify="members"><span class="loader" ></span><span class="msg"></span>
		</div>
	</form>
</div>
