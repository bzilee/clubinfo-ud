...
<div class="header" id="header">
      <div class="slider-show" id="slider-show" style="">
          ...
          <div class="list-content" id="list-content" >
            <div class="slides">
                <ul> <!-- slides -->
                     <li><img class="img-slide" src="assets/app/images/slider/bg_alt_2.jpg" alt="image01" />

                    </li>
                    <li><img class="img-slide" src="assets/app/images/slider/bg_alt_1.jpg" alt="image02" />

                    </li>
                    <li><img class="img-slide" src="assets/app/images/slider/bg_alt_3.jpg" alt="image03" />

                    </li>
                    <li><img class="img-slide" src="assets/app/images/slider/bg_alt_6.jpg" alt="image04" />
